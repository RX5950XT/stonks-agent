...
- P0 Foundation、P1 Canonical Data Hub與P2 Research control plane phase gates已完成；P3.1–P3.5 strategy contracts、registry、baselines、evaluation與opinion mapper已完成，下一目標為P3.6 Kronos isolated worker。
...
2. 保持 TDD；從P3.6 Kronos isolated worker開始，先固定source/model/tokenizer revisions與checksums、offline warm-once loader、CPU/CUDA分離profile及無DB/broker credentials的hardened runtime。
