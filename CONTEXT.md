...
- P0 Foundation 與 P1 Canonical Data Hub phase gates已完成；P2.1–P2.6 research contracts、bounded orchestrator、structured-output LLM adapters、TradingAgents worker/core adapter，以及draft PEAD/event-study已完成，下一目標為P2.7 analysis context/evidence assembler。
...
2. 保持 TDD；從P2.7 analysis context/evidence assembler開始，只讀canonical evidence並保留missing/stale/conflict與provenance狀態。
