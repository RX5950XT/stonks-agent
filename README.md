...
Stonks Agent 是 evidence-first、可稽核、可重播的投資研究與 paper trading 平台。P0 Foundation、P1 Canonical Data Hub、P2 Research control plane、P3 strategy/forecast/evaluation 與 P4 PostgreSQL paper fund 已通過 phase gate；P5.1–P5.6 external platform、AI-Trader adapter、community feedback policy、canonical backtest contracts、NautilusTrader 與 QuantConnect LEAN sidecars 已完成，後續工作依[實作計畫](./tasks/todo.md)持續開發。
