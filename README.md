...
Stonks Agent 是 evidence-first、可稽核、可重播的投資研究與 paper trading 平台。P0 Foundation、P1 Canonical Data Hub 與 P2 Research control plane 已通過 phase gate；P3 strategy/forecast/evaluation 已完成P3.1–P3.7，後續工作依[實作計畫](./tasks/todo.md)持續開發。
