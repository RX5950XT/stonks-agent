...
Stonks Agent 是 evidence-first、可稽核、可重播的投資研究與 paper trading 平台。P0–P5 phase gates與P6.1 production OIDC/RBAC/service identities已通過，P6.2之後的production hardening依[實作計畫](./tasks/todo.md)持續開發。
