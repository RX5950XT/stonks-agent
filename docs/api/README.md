...
| [gui.openapi.json](../../schemas/openapi/v1/gui.openapi.json) | `Stonks Terminal` | `/api/v1/capabilities`；`/api/v1/market/bars`；`/api/v1/market/quotes`；`/api/v1/market-data/latest`；`/api/v1/settings/llm`；`/api/v1/research/runs`；`/api/v1/research/runs/{run_id}`；`/api/v1/research/runs/{run_id}/events`；`/api/v1/research/runs/{run_id}/evidence` |
