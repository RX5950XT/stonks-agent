"""Bounded HTTP surface for the optional QuantConnect LEAN sidecar."""
...
def create_app(
    *,
    ...
    app = FastAPI(
        title="Stonks LEAN Backtest Sidecar",
        docs_url=None,
        redoc_url=None,
        openapi_url=None,
    )
    ...
    async def backtest(incoming: Request) -> JSONResponse:
        ...
        try:
            ...
            return _error(429, "worker_busy", "LEAN worker is at capacity")
        try:
            try:
